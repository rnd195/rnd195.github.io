...
in your terminal. Make sure that the local user Python scripts folder (on Windows, typically: `%APPDATA%\Python\<Python version>\Scripts`) is in your PATH environment variable. You can also install `uv` directly (see [docs](https://docs.astral.sh/uv/getting-started/installation/)), which should work without making additional changes.
